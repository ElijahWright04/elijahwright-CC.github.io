            ...
            products.forEach(product => {
                output += `
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <img src="${product.image}" class="card-img-top" alt="${product.gear_name}">
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary" onclick="buyNow('${product.gear_name}', ${product.gear_cost})">Buy Now</button>
                            </div>
                        </div>
                    </div>
                `;
